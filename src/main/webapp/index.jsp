...
%>
<tr <%= bluetag? "class=bluetag":"" %>><td>
  <%= logNames.get(code) %>
</td><td><a href="/exc/exc?name=<%= code %>">
  /exc/exc?name=<%= code %>
</a></td></tr>
<%
  bluetag = !bluetag;
...
%>
        ...
        <p>Exception can be clicked to see appropriate part of log.<br/>Current line will be highlighted.<br/>First or last line of log in browser can be clicked to scroll the log.</p>
